...
import org.activemath.xlm.model.cmaps.MetacogMap;

import com.l2fprod.common.beans.editor.ComboBoxPropertyEditor;

public class MetacogEditor extends ComboBoxPropertyEditor {




    public MetacogEditor() {
        super();    
        
        XlmManager manager = XlmManager.getInstance();
        MetacogMap map = manager.getMapMetacog();
